...
* You can enable your users to be automatically signed-in to Bynder (Single Sign-On) with their Azure AD accounts.
...
4. In the search box, type **Bynder**, select **Bynder** from result panel then click **Add** button to add the application.
	 ...
	 ![Bynder in the results list](common/search-new-app.png)
...
For single sign-on to work, a link relationship between an Azure AD user and the related user in Bynder needs to be established.
...
1. In the [Azure portal](https://portal.azure.com/), on the **Bynder** application integration page, select **Single sign-on**.
...
4. On the **Basic SAML Configuration** section, If you wish to configure the application in **IDP** initiated mode, perform the following steps:
    ...
    ![Bynder Domain and URLs single sign-on information](common/idp-intiated.png)
...
5. Click **Set additional URLs** and perform the following step if you wish to configure the application in **SP** initiated mode:
    ...
    ![Bynder Domain and URLs single sign-on information](common/metadata-upload-additional-signon.png)
...
7. On the **Set up Bynder** section, copy the appropriate URL(s) as per your requirement.
...
### Configure Bynder Single Sign-On

To configure single sign-on on **Bynder** side, you need to send the downloaded **Federation Metadata XML** and appropriate copied URLs from Azure portal to [Bynder support team](https://www.bynder.com/en/support/). They set this setting to have the SAML SSO connection set properly on both sides.
...
1. In the Azure portal, select **Enterprise Applications**, select **All applications**, then select **Bynder**.

	![Enterprise applications blade](common/enterprise-applications.png)

2. In the applications list, select **Bynder**.

	![The Bynder link in the Applications list](common/all-applications.png)
